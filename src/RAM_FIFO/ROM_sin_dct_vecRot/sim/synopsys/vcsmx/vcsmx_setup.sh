...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../rom_1port_151/sim/ROM_sin_dct_vecRot_rom_1port_151_xhfa2qa.v" -work ROM_sin_dct_vecRot_rom_1port_151
