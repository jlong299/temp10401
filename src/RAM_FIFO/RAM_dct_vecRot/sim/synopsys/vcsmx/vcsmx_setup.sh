...
mkdir -p ./libraries/RAM_dct_vecRot_ram_2port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_dct_vecRot_ram_2port_151_byb7zvy.v" -work RAM_dct_vecRot_ram_2port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_dct_vecRot.v"                                                                              
fi
