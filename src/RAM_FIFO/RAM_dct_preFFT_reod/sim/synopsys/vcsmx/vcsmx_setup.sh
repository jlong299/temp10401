...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_dct_preFFT_reod_ram_2port_151_nn5gxoa.v" -work RAM_dct_preFFT_reod_ram_2port_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_dct_preFFT_reod.v"                                                                                   
fi
