...
TOP_LEVEL_NAME="RAM_dct_preFFT_reod"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/RAM_dct_preFFT_reod_ram_2port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_dct_preFFT_reod_ram_2port_151_nn5gxoa.v" -work RAM_dct_preFFT_reod_ram_2port_151 -cdslib ./cds_libs/RAM_dct_preFFT_reod_ram_2port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_dct_preFFT_reod.v"                                                                                                                                                
fi
