...
# # End of template
# ----------------------------------------
# If RAM_dct_preFFT_reod is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.10.31.15:10:17
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "RAM_dct_preFFT_reod"
}
...
ensure_lib                                   ./libraries/RAM_dct_preFFT_reod_ram_2port_151/
vmap       RAM_dct_preFFT_reod_ram_2port_151 ./libraries/RAM_dct_preFFT_reod_ram_2port_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/RAM_dct_preFFT_reod_ram_2port_151_nn5gxoa.v" -work RAM_dct_preFFT_reod_ram_2port_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_dct_preFFT_reod.v"                                                                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L RAM_dct_preFFT_reod_ram_2port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L RAM_dct_preFFT_reod_ram_2port_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
